...
package fr.rtone.android.devoxxfr.profile;
...
public abstract class BleProfileService extends Service implements BleManagerCallbacks {
	...
	public static final String BROADCAST_CONNECTION_STATE = "fr.rtone.android.devoxxfr.BROADCAST_CONNECTION_STATE";
	public static final String BROADCAST_SERVICES_DISCOVERED = "fr.rtone.android.devoxxfr.BROADCAST_SERVICES_DISCOVERED";
	public static final String BROADCAST_DEVICE_READY = "fr.rtone.android.devoxxfr.DEVICE_READY";
	public static final String BROADCAST_BOND_STATE = "fr.rtone.android.devoxxfr.BROADCAST_BOND_STATE";
	public static final String BROADCAST_BATTERY_LEVEL = "fr.rtone.android.devoxxfr.BROADCAST_BATTERY_LEVEL";
	public static final String BROADCAST_ERROR = "fr.rtone.android.devoxxfr.BROADCAST_ERROR";

	/** The parameter passed when creating the service. Must contain the address of the sensor that we want to connect to */
	public static final String EXTRA_DEVICE_ADDRESS = "fr.rtone.android.devoxxfr.EXTRA_DEVICE_ADDRESS";
	/** The key for the device name that is returned in {@link #BROADCAST_CONNECTION_STATE} with state {@link #STATE_CONNECTED}. */
	public static final String EXTRA_DEVICE_NAME = "fr.rtone.android.devoxxfr.EXTRA_DEVICE_NAME";
	public static final String EXTRA_CONNECTION_STATE = "fr.rtone.android.devoxxfr.EXTRA_CONNECTION_STATE";
	public static final String EXTRA_BOND_STATE = "fr.rtone.android.devoxxfr.EXTRA_BOND_STATE";
	public static final String EXTRA_SERVICE_PRIMARY = "fr.rtone.android.devoxxfr.EXTRA_SERVICE_PRIMARY";
	public static final String EXTRA_SERVICE_SECONDARY = "fr.rtone.android.devoxxfr.EXTRA_SERVICE_SECONDARY";
	public static final String EXTRA_BATTERY_LEVEL = "fr.rtone.android.devoxxfr.EXTRA_BATTERY_LEVEL";
	public static final String EXTRA_ERROR_MESSAGE = "fr.rtone.android.devoxxfr.EXTRA_ERROR_MESSAGE";
	public static final String EXTRA_ERROR_CODE = "fr.rtone.android.devoxxfr.EXTRA_ERROR_CODE";
