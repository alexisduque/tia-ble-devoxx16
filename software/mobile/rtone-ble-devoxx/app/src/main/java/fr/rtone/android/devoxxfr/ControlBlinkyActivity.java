...
public class ControlBlinkyActivity extends AppCompatActivity {
	...
	private BroadcastReceiver mBlinkyUpdateReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			switch (action) {
				...
				case BlinkyService.BROADCAST_BATTERY_LEVEL: {
					final int message = intent.getIntExtra(BlinkyService.EXTRA_BATTERY_LEVEL, 0);
	...
	private static IntentFilter makeGattUpdateIntentFilter() {
		...
		intentFilter.addAction(BlinkyService.BROADCAST_BATTERY_LEVEL);
